      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="transactionhistory.php"><button style="background-color : #2785C4;">History of Transaction</button></a>
                  </div>
            </div>
      </div>
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Somdeb Bhattacharjee</b> <br> Somdeb Bhattacharjee Pvt. Ltd.</p>
      </footer>
